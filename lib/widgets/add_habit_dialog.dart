...
class _AddHabitDialogState extends State<AddHabitDialog> {
  ...
  void initState() {
    super.initState();
    if (widget.isEditing && widget.habitToEdit != null) {
      ...
      _selectedFrequency = widget.habitToEdit!.frequency;
            ...
            SnackBar(
              content: Row(
                children: [
                  ...
                  const Text('Habit updated successfully!'),
                ],
              ),
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Text('Failed to ${widget.isEditing ? 'update' : 'create'} habit: $e'),
              ],
            ),
